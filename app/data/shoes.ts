// Generated from shoes database v4.0.0 and market-audited on 2026-07-16.
// Do not edit the JSON objects directly; update through the catalog pipeline.
//
// IMPORTANT:
// - SHOES is an alias of CURRENT_SHOES so existing app imports keep working.
// - UPCOMING_SHOES must never be recommended as purchasable now.
// - LEGACY_SHOES stays available for mileage/history tracking only.
// - "official_model_provisional_specs" means the model/version is confirmed, while some
//   biomechanics scores were carried forward until STRIDE completes hands-on profiling.
...
export type ShoeMarketStatus = "available" | "preorder" | "upcoming" | "legacy";
export type ShoeDataConfidence =
  | "official_specs"
  | "official_model_provisional_specs"
  | "announced_provisional"
  | "carried_forward"
  | "legacy_original";
...
export interface Shoe {
  ...
  summary: string;
  market_status?: ShoeMarketStatus;
  verified_as_of?: string;
  data_confidence?: ShoeDataConfidence;
}

export const MARKET_VERIFIED_AS_OF = "2026-07-16";

export const CURRENT_SHOES: Shoe[] = [
  {
    ...
    "data_confidence": "carried_forward",
  ...
  },
  {
    ...
    "avoid_for_conditions": [],
    "verified_as_of": "2026-07-16",
    "data_confidence": "official_model_provisional_specs",
    "market_status": "available"
  },
  {
    "id": "altra_king_mt_2",
  ...
  },
  {
    ...
    "verified_as_of": "2026-07-16",
    "data_confidence": "official_specs",
    "market_status": "available"
  },
  {
    "id": "asics_s4_yogiri",
  ...
  },
  {
    ...
    "summary": "Current Clifton generation: balanced everyday cushioning for running and walking.",
    "avoid_for_conditions": [],
    "verified_as_of": "2026-07-16",
    "data_confidence": "official_specs",
    "market_status": "available",
  ...
  },
  {
    ...
    "summary": "Performance-oriented Clifton with moderate J-Frame guidance and an 8mm drop.",
    "avoid_for_conditions": [
      "overpronation_severe"
    ],
    "verified_as_of": "2026-07-16",
  ...
  },
  {
    ...
    "summary": "Current technical-trail Mafate generation with high protection and aggressive grip.",
    "avoid_for_conditions": [],
    "verified_as_of": "2026-07-16",
    "data_confidence": "official_specs",
    "market_status": "available"
  ...
  },
  {
    ...
    "summary": "Carbon-plated trail racer built for fast technical and ultra-distance racing.",
    "avoid_for_conditions": [],
    "verified_as_of": "2026-07-16",
    "data_confidence": "official_model_provisional_specs",
    "market_status": "available",
  ...
  {
    "id": "nb_supercomp_pacer_v2",
    "brand": "New Balance",
    "model": "FuelCell SuperComp Pacer v2",
    "year": 2026,
    "price_usd": 180,
    "category": "carbon_racer",
    "use_cases": [
  ...
  {
    "id": "on_cloudsurfer_trail_2",
    "brand": "On",
    "model": "Cloudsurfer Trail 2",
    "year": 2026,
    "price_usd": 170,
    "category": "trail_neutral",
    "use_cases": [
  ...
  },
  {
    ...
    "summary": "Salomon road-racing flagship with PEBA-based foam, a full carbon plate, and an aerodynamic upper.",
    "verified_as_of": "2026-07-16",
    "data_confidence": "official_specs",
    "market_status": "available"
  },
  ...
  {
    "id": "topo_ultraventure_5",
    "brand": "Topo",
    "model": "Ultraventure 5",
    "year": 2026,
    "price_usd": 170,
    "category": "trail_max_cushion",
    "use_cases": [
...
export const UPCOMING_SHOES: Shoe[] = [
  {
    ...
    "verified_as_of": "2026-07-16",
    "data_confidence": "announced_provisional",
...
export const LEGACY_SHOES: Shoe[] = [
  {
  ...
  },
  {
    ...
    "market_status": "legacy",
    "verified_as_of": "2026-07-16",
    "data_confidence": "legacy_original"
  },
  {
...
export const SHOES: Shoe[] = CURRENT_SHOES;

export const ALL_TRACKABLE_SHOES: Shoe[] = [
  ...CURRENT_SHOES,
  ...UPCOMING_SHOES,
  ...LEGACY_SHOES,
];

export interface PendingMarketModel {
  brand: string;
  model: string;
  status: string;
  expected?: string;
...
export const MARKET_MODELS_PENDING_PROFILE: PendingMarketModel[] = [
  {
    "brand": "ASICS",
    "model": "DYNABLAST 6",
    "status": "available"
  ...
  {
    "brand": "Salomon",
    "model": "Aero Glide 4 GRVL",
    "status": "available"
  }
];

export const ANNOUNCED_MODELS_PENDING_PROFILE: PendingMarketModel[] = [
  {
    "brand": "Brooks",
    "model": "Ghost Amp",
    "status": "preorder"
  ...
  {
    "brand": "Brooks",
    "model": "Hyperion Max 4",
    "status": "preorder"
  },
  {
    "brand": "HOKA",
    "model": "Clifton 11 GTX",
    "status": "coming_soon"
  },
  {
    "brand": "ASICS",
